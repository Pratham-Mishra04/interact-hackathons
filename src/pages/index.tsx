  ...
  return (
    ...
    >
      <div className={'flex flex-col justify-center'}>
        <div className={'text-center text-4xl max-sm:text-2xl font-bold text-transparent bg-clip-text text-center px-4'}
             style={{
        ...
        >{card.text}</div>
        <Link className={'border border-white rounded-full p-2 px-3 max-sm:py-1.5 max-sm:px-2 flex items-center gap-1.5 hover:bg-white/20'} href={card.href}>
